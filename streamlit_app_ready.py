...
with col2:
    st.markdown("""
    <div style='text-align: right; font-size: 20px; font-weight: bold; padding-top: 10px;'>
        משרד עורכי דין יוסי בן אבו<br>
...
# כותרת ראשית
st.markdown(f"""
<div style='text-align: right; padding: 10px 0; font-size: 24px; font-weight: bold; color: #003366;'>
