...
st.markdown(f"""
<div style='background: linear-gradient(to right, #e0f7fa, #ffffff); padding: 25px; border: 2px solid #007ACC; border-radius: 12px; margin-bottom: 20px; direction: rtl;'>
    <div style='display: flex; justify-content: space-between; align-items: center;'>
        <div style='text-align: right;'>
            <h2 style='margin: 0; font-size: 28px; color: #003366;'>משרד עורך דין יוסי בן אבו</h2>
            <p style='margin: 5px 0 0 0; font-size: 16px; color: #004466;'>ביטוח לאומי ודיני עבודה</p>
        </div>
        <div style='max-width: 80px; height: auto; overflow: hidden;'>{logo_svg}</div>
    </div>
    <hr style='margin: 15px 0;' />
    <h1 style='text-align: center; font-size: 32px; color: #003366;'>מערכת לאיתור אחוזי נכות</h1>
    <div style='text-align: left; font-size: 12px; color: #666;'>גרסה 1.0 | {today}</div>
</div>
...
if "df" in st.session_state:
    ...
    # צ'קבוקסים להצגת עמודות - תמיד לפי df המקורי
