...
with col2:
    ...
    <div style='text-align: right; padding-top: 10px;'>
        <div style='font-size: 22px; font-weight: bold;'>משרד עורכי דין יוסי בן אבו</div>
        <div style='font-size: 16px; color: #444;'>ביטוח לאומי ודיני עבודה</div>
    </div>
    """, unsafe_allow_html=True)

# כותרת ראשית
st.markdown(f"""
<div style='text-align: center; padding: 15px 0; font-size: 26px; font-weight: bold; color: #003366;'>
